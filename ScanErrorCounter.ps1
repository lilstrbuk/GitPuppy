# How to call this
# :: Call the script to gather bad knife scan counts
# "C:\Puppy\PowerShell-7\pwsh.exe" -ExecutionPolicy Bypass -File "C:\Puppy\ScanErrorCounter.ps1" "%date_format%" "%PlantName%" "%sub_folder%"
